...
B = (
    Permutation(1, 14, 48, 27)
    * Permutation(2, 12, 47, 29)
    * Permutation(3, 9, 46, 32)
    * Permutation(33, 35, 40, 38)
    * Permutation(34, 37, 39, 36)
)

D = (
    Permutation(14, 22, 30, 38)
    * Permutation(15, 23, 31, 39)
    * Permutation(16, 24, 32, 40)
